...
public class ManageMedicinesPage extends JFrame {
    ...
    public ManageMedicinesPage(Manager managerUser) {
        ...
        loadButton.addActionListener(new ListenerHelper.LoadButtonListener(tableModel, managerUser::getMedicinePublicRecords, new JButton[] {editButton, deleteButton}));
